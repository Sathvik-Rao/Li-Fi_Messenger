...
Identify your Java Runtime Environment's folder. For version 1.6.0, this usually is c:\Program Files\Java\jre1.6.0_01\ 
    ...
    from installed folder open rxtx-2.1-7-bins-r2\64bit and
    Copy rxtxParallel.dll to c:\Program Files\Java\jdk1.8.0_161\jre\bin\        (or/and) C:\Program Files\Java\jre1.8.0_241\bin
    Copy rxtxSerial.dll to c:\Program Files\Java\jdk1.8.0_161\jre\bin\          (or/and) C:\Program Files\Java\jre1.8.0_241\bin
    Copy RXTXcomm.jar to c:\Program Files\Java\jdk1.8.0_161\jre\lib\ext\  (or/and)  C:\Program Files\Java\jre1.8.0_241\lib\ext
